...
**Interpretation:** `r if(evalue_main$est.Evalue > 2) paste0("The E-value of ", round(evalue_main$est.Evalue, 2), " suggests that unmeasured confounding would need to be relatively strong to explain away the observed association.") else if(evalue_main$est.Evalue > 1.5) paste0("The E-value of ", round(evalue_main$est.Evalue, 2), " suggests moderate robustness to unmeasured confounding.") else paste0("The E-value of ", round(evalue_main$est.Evalue, 2), " suggests the finding could be sensitive to unmeasured confounding.")`
...
**Main Findings:**  
- Overall E-value: `r round(evalue_main$est.Evalue, 2)`  
