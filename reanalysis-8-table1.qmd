...
format_stratified_table <- function(table_data, title) {
  ...
  # Display totals
  cat("**Total Patients**\n")
  knitr::kable(table_data$totals)
  
  cat("\n**Demographic Characteristics**\n")
  
  cat("\n*Sex*\n")
  knitr::kable(table_data$sex)
  
  cat("\n*Age (years)*\n")
  knitr::kable(table_data$age)
  
  cat("\n*Race/Ethnicity*\n")
  knitr::kable(table_data$race)
  
  cat("\n*Insurance*\n")
  knitr::kable(table_data$insurance)
  
  cat("\n**Ocular Characteristics**\n")
  
  cat("\n*Severity of DR*\n")
  knitr::kable(table_data$dr)
  ...
  treatments_df <- data.frame(
    ...
    Total = c(
      sprintf("%d (%.0f%%)", table_data$treatments$prp$n[3], table_data$treatments$prp$pct[3]),
      sprintf("%d (%.0f%%)", table_data$treatments$focal$n[3], table_data$treatments$focal$pct[3]),
      sprintf("%d (%.0f%%)", table_data$treatments$vegf$n[3], table_data$treatments$vegf$pct[3]),
      sprintf("%d (%.0f%%)", table_data$treatments$other$n[3], table_data$treatments$other$pct[3])
    )
  )
  knitr::kable(treatments_df, col.names = c("Treatment", "Lapse in care", "No lapse in care", "Total"))
  ...
  comorb_df <- data.frame(
    ...
    Total = c(
      sprintf("%d (%.0f%%)", table_data$comorbidities$glaucoma$n[3], table_data$comorbidities$glaucoma$pct[3]),
      sprintf("%d (%.0f%%)", table_data$comorbidities$cataract$n[3], table_data$comorbidities$cataract$pct[3]),
      sprintf("%d (%.0f%%)", table_data$comorbidities$retina$n[3], table_data$comorbidities$retina$pct[3])
    )
  )
  knitr::kable(comorb_df, col.names = c("Condition", "Lapse in care", "No lapse in care", "Total"))
  ...
  knitr::kable(clinical_df, col.names = c("Variable", "Lapse in care", "No lapse in care", "Total"))
}
...
export_stratified_table <- function(table_data, filename) {
  ...
  export_df <- rbind(export_df, data.frame(
    ...
    lapse_prop = lapse_total$pct,
    lapse_sd = NA,
    no_lapse_value = no_lapse_total$n,
    no_lapse_prop = no_lapse_total$pct,
    no_lapse_sd = NA,
  ...
  for (j in 1:length(treatment_names)) {
    if (!is.null(treatment_data[[j]])) {
      ...
      export_df <- rbind(export_df, data.frame(
        ...
        lapse_prop = tx_data$pct[tx_data$lapse_group == "Lapse in care"],
        lapse_sd = NA,
        no_lapse_value = tx_data$n[tx_data$lapse_group == "No lapse in care"],
        no_lapse_prop = tx_data$pct[tx_data$lapse_group == "No lapse in care"],
        no_lapse_sd = NA,
        total_value = tx_data$n[tx_data$lapse_group == "Total"],
        total_prop = tx_data$pct[tx_data$lapse_group == "Total"],
        total_sd = NA
      ))
    }
  }
  ...
  for (j in 1:length(comorb_names)) {
    if (!is.null(comorb_data[[j]])) {
      ...
      export_df <- rbind(export_df, data.frame(
        ...
        lapse_prop = com_data$pct[com_data$lapse_group == "Lapse in care"],
        lapse_sd = NA,
        no_lapse_value = com_data$n[com_data$lapse_group == "No lapse in care"],
        no_lapse_prop = com_data$pct[com_data$lapse_group == "No lapse in care"],
        no_lapse_sd = NA,
        total_value = com_data$n[com_data$lapse_group == "Total"],
        total_prop = com_data$pct[com_data$lapse_group == "Total"],
        total_sd = NA
      ))
    }
  }
  ...
  for (cv in cont_vars) {
    if (!is.null(cv$data)) {
      ...
      export_df <- rbind(export_df, data.frame(
        variable = cv$name,
        lapse_value = lapse_stats$mean,
        lapse_prop = NA,
        lapse_sd = lapse_stats$sd,
        no_lapse_value = no_lapse_stats$mean,
        no_lapse_prop = NA,
        no_lapse_sd = no_lapse_stats$sd,
        total_value = total_stats$mean,
        total_prop = NA,
