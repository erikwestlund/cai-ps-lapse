...
# Pool using mice with Barnard-Rubin df
...
pooled_results <- pooled_summary |>
  mutate(
    ...
    SE = std.error,
    t_stat = statistic,
    df = df,  # Barnard-Rubin adjusted degrees of freedom
    P_Value = p.value,
...
# Get pooled variance-covariance matrix for later calculations
# Note: vcov() works on the pooled_model object, not the results data frame
