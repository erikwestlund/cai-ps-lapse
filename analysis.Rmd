...
# save_og_image function is now loaded from functions.R 
...
```{r get_m_data}
# Apply exclusions (removes missing CCI/DCSI)
...
```{r analysis_setup}
# Get the analysis formulas from functions.R
analysis_formulas <- get_analysis_formulas()
analysisFormulaSimple <- analysis_formulas$simple
analysisFormulaMiddle <- analysis_formulas$middle
analysisFormulaFull <- analysis_formulas$full

# fit_logistic_models function is now loaded from functions.R

# summarize_logistic_models function is now loaded from functions.R
...
# tidy_output_model_formatted function is now loaded from functions.R
