...
for (i in imps_to_show) {
  ...
  summary_df <- data.frame(
    ...
    Unweighted = c(
      ...
      round(bal_table$unw$max.es, 4),
      round(bal_table$unw$mean.es, 4),
      round(bal_table$unw$max.ks, 4),
      NA
    ),
    Weighted = c(
      es_mean_stats$n.treat,
      es_mean_stats$n.ctrl,
      round(es_mean_stats$ess.treat, 2),
      round(es_mean_stats$ess.ctrl, 2),
      round(bal_table$es.mean$max.es, 4),
      round(bal_table$es.mean$mean.es, 4),
      round(bal_table$es.mean$max.ks, 4),
