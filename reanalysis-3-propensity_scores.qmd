...
for (i in 1:n_imputations) {
  ...
  # Use bal.table to get balance statistics
  # This function should work with the ps object
  bal_table <- tryCatch({
    bal.table(twang_model, digits = 3)
  }, error = function(e) {
    # If bal.table doesn't work, try summary
    tryCatch({
      summary(twang_model)$es.mean.ATT
    }, error = function(e2) {
      NULL
