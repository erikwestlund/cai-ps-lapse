...
for (i in imps_to_show) {
  ...
  # Plot 1: Iteration convergence
  cat("#### Convergence\n")
  plot(twang_model, plots = 1)
  
  # Plot 2: Boxplots of weights
  cat("\n#### Weight Distribution\n")
  plot(twang_model, plots = 2)
  
  # Plot 3: Balance reduction (standardized effect sizes)
  cat("\n#### Covariate Balance\n")
  plot(twang_model, plots = 3)
  
  # Plot 6: Proportion of weights histogram
  cat("\n#### Weight Proportions\n")
  plot(twang_model, plots = 6)
...
if (avg_weights$Max_Weight_Overall > 10) {
  ...
  print("GOOD: Weights appear stable (max < 10)")
}
```
