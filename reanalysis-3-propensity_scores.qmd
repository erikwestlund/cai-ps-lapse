...
if (analysis_mode == "test") {
  max_imputations_to_process <- 1  # Process only 2 imputations in test mode
  max_imputations_for_diagnostics <- 1  # Show diagnostics for 2 imputations in test
...
for (i in imps_to_show) {
  ...
  cat("#### Alternative Balance Plot (Love Plot)\n\n")
