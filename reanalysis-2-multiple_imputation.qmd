...
vars_always_predict <- c(
  ...
  "age",                    # Demographics
  "gender_cat",
  "race_ethnic_cat",        # Demographics
  "insurance_cat",          # Demographics/SES
  "CCI", "DCSI",           # Comorbidities
  "person_dr",              # DR severity - key clinical variable
  "anti_VEGF",              # Key treatment
  "focal_laser_flag",       # Treatment
  "PRP_flag",               # Treatment
  "glaucoma_bef_hitplus_cat",  # Ocular comorbidity
  "otherretina_bef_hitplus_cat", # Ocular comorbidity
  "catsurg_before_hitplus_cat",  # Cataract surgery
  "fellow_baseline_VA", "fellow_intermediate_VA", "fellow_outcome_VA", "fellow_dr" # Fellow-eye predictors
)
...
# Lower threshold to 0.05 to capture more predictive relationships
# This includes variables with correlations >= 0.05 (R^2 >= 0.0025)
pred_matrix <- quickpred(
  df_mice, 
  exclude = vars_never_predict,
  include = vars_always_predict,
  mincor = 0.05,  # Lowered from 0.10 to include more predictors
  method = "pearson"
)
