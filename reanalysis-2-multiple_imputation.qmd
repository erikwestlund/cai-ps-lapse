...
# EXCEPT: e_mrn_deidentified is set to -2 as cluster indicator for 2l methods
pred_matrix[, "e_mrn_deidentified"] <- -2  # Cluster indicator for 2l.pan
pred_matrix["e_mrn_deidentified", ] <- 0  # Don't predict e_mrn itself
