...
# NOTE: 2l.pmm requires clean variable names (no spaces) in factor levels
...
# CCI and DCSI could potentially vary by eye visit, so use 2-level
custom_methods["CCI"] <- "2l.pmm"  # Multilevel PMM for clustered data
custom_methods["DCSI"] <- "2l.pmm"  # Multilevel PMM for clustered data
