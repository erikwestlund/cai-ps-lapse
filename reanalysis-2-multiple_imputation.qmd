...
if ("fellow_baseline_VA" %in% colnames(pred_matrix)) {
  pred_matrix["baseline_VA_logMAR", "fellow_baseline_VA"] <- 2  # Weight=2
}
if ("fellow_intermediate_VA" %in% colnames(pred_matrix)) {
  pred_matrix["intermediate_VA_logMAR", "fellow_intermediate_VA"] <- 2  # Weight=2
}
if ("fellow_outcome_VA" %in% colnames(pred_matrix)) {
  pred_matrix["outcome_VA_logMAR", "fellow_outcome_VA"] <- 2  # Weight=2
}
if ("fellow_dr" %in% colnames(pred_matrix) && "person_dr" %in% rownames(pred_matrix)) {
  pred_matrix["person_dr", "fellow_dr"] <- 2  # Weight=2
}
