...
# ExtractSmd returns a list where each element is the SMD for a variable
smd_values <- unlist(smd_raw[1:(length(smd_raw)-1)])  # Exclude the Variable element
variable_names <- names(smd_values)
