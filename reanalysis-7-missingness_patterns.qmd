...
# First, check what columns exist in the processed data
cat("Sample of columns in processed data:\n")
cat(paste(names(original_data)[1:min(30, length(names(original_data)))], collapse = "\n"))
cat("\n...\n")
cat("Total columns:", length(names(original_data)), "\n\n")
