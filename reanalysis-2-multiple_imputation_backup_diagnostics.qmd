...
invalid_methods <- custom_methods[!custom_methods %in% c("", "pmm", "logreg", "polyreg", "polr", "norm", "norm.boot", "norm.nob", "norm.predict", "sample", "cart", "rf", "2l.norm", "2l.lmer", "2l.pan", "2lonly.mean", "2lonly.norm", "2lonly.pmm")]
...
# Temporal VA variables - use 2-level PMM to account for patient clustering
custom_methods["baseline_VA_logMAR"] <- "2l.pmm"  # 2-level PMM for clustered data
custom_methods["intermediate_VA_logMAR"] <- "2l.pmm"  # 2-level PMM for clustered data
custom_methods["outcome_VA_logMAR"] <- "2l.pmm"  # 2-level PMM for clustered data
custom_methods["cohort_id"] <- ""  # Never impute - data management indicator only

# Other continuous variables - use 2-level PMM for patient clustering
custom_methods["CCI"] <- "2l.pmm"  # 2-level PMM for count data
custom_methods["DCSI"] <- "2l.pmm"  # 2-level PMM for count data
custom_methods["age"] <- "2l.pmm"  # Keep as regular PMM since age doesn't vary within patient
...
# Mark e_mrn_deidentified as cluster variable for 2-level imputation
# -2 indicates this is the cluster ID (patient ID)
