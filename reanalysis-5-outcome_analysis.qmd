...
if (!is.null(emm_results)) {
  ...
  if (!("lower.CL" %in% names(contrasts_df))) {
    ...
    contrasts_df <- cbind(contrasts_df, contrasts_ci[, c("lower.CL", "upper.CL")])
  }
  ...
  or_display <- data.frame(
    ...
    CI_Lower = round(1/contrasts_df$upper.CL[1], 3),  # Invert and swap
    CI_Upper = round(1/contrasts_df$lower.CL[1], 3),  # Invert and swap
