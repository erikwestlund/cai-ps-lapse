...
# Assign node IDs based on batch processing
batch_size <- ceiling(n_imputations / ceiling(n_imputations / n_cores))
for (i in 1:n_imputations) {
  imputation_node_assignments$node_id[i] <- get_next_node_id()
}
