...
# Check if we have probability table data
if(exists("prob_table") && nrow(prob_table) > 0 && !any(is.na(prob_table$Difference))) {
  ...
  cat("Skipping probability differences plot - data not available from emmeans calculation.\n")
