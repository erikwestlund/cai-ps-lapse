...
```{r twang_summary}
# Display twang model summary for verification
print(twang_model)

# Show the number of iterations and balance achieved
cat("\nOptimal iteration (es.mean):", twang_model$desc$es.mean.ATT$n.trees, "\n")
cat("Maximum effect size at optimal iteration:", 
    round(max(abs(twang_model$desc$es.mean.ATT$results$std.eff.sz)), 4), "\n")
```
